...
class Relatorio {
    ...
    public function getRelatorio($request) {
        ...
        return DB::select("SELECT *, sum(valor_nota) as soma_valor_nota, sum(valor_produto) as soma_valor_produto, sum(valor_total) as soma_valor_total, COUNT(DISTINCT produto_id) as produtos_diferentes,
